...
Original file is located at
    https://colab.research.google.com/drive/1o-OwJtScsLnSdPduO4A7kdZyMGkMeuVw
"""
...
def solution_C1():
    ...
    model.compile(optimizer=tf.keras.optimizers.SGD(learning_rate = 0.055), loss='mean_squared_error')
